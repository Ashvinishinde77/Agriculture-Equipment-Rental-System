 ...
 <link rel="stylesheet" href="./resources/bootstrap-3.3.6-dist/css/bootstrap.min.css">
  ...
  <script type="text/javascript">
    ...
    var selectedtype= (obj.options[obj.selectedIndex].value);
		...
		{
			document.getElementById("del_charge").style="display:show;";
		}
		else
		{
			document.getElementById("del_charge").style="display:none;";			
		}
    }
</script>
</head>
 ...
 <form enctype="multipart/form-data" data-toggle="validator" onsubmit="addnewline();" role="form" method="post" action="">
  ...
  <div class="form-group" style="display:none;">
   <label class="control-label">Enter Full Price</label>
    <input class="form-control" type="number" id="full_price" name= "full_price" value="0.00" placeholder="Enter Full Price">
  </div> 
  <div class="form-group">
  ...
  <div class="form-group">
	<label class="control-label">Select Delivery/Operator Charges </label>
		<select class="form-control" id="delvry_charge" name="delvry_charge" onChange="changefile(this)" required>
		  <option value="">Select Delivery Charges</option>
		 <option value="Applicable">Delivery/Operator Charges Applicable</option>					  
		 <option value="Not Applicable">Delivery/Operator Charges Not Applicable</option>					  					  					 
		</select>
  </div>
  <div class="form-group" id="del_charge" style="display:none;">
   <label class="control-label">Enter Delivery Charges</label>
    <input class="form-control" type="number" id="delivery_charges" name= "delivery_charges" value="0.00" placeholder="Enter Delivery Charges">
  </div>
  <div class="form-group">
